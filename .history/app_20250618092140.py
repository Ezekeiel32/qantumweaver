...
@app.get("/jobs")
async def jobs_alias(limit: int = 20):
    return await list_jobs_endpoint(limit=limit)

@app.get("/system/stats")
async def system_stats_alias():
    return await get_system_general_stats_endpoint()
