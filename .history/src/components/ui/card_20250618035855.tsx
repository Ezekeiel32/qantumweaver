...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "neon-card glass bg-white/5 backdrop-blur-xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-white/10 hover:border-white/20 rounded-xl overflow-hidden",
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "neon-heading text-2xl font-bold leading-none tracking-tight bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent",
      "drop-shadow-sm",
      className
    )}
    {...props}
