...
export default function NeonAnalyzerChart({
  ...
  function renderMiniMapExternal() {
    ...
    return (
      <div style={{
        width: 140, height: 36, background: "#10131aCC", border: "1.5px solid #00ffe7", borderRadius: 8, zIndex: 3, boxShadow: "0 0 4px #00ffe7", display: "flex", alignItems: "center", justifyContent: "center", padding: 2, marginBottom: 16
      }}>
