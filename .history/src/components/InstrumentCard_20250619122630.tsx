...
const InstrumentCard: React.FC<InstrumentCardProps> = ({
  ...
  return (
    <div className="instrument-card bg-black/90 border-4 border-neon-blue rounded-xl shadow-neon-blue/40 absolute top-0 left-[260px] right-0 bottom-0 flex flex-col w-auto h-full z-10" style={{ boxShadow: '0 0 32px 4px #00f0ff55' }}>
      {/* Grid Overlay */}
