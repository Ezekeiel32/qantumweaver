...
const InstrumentCard: React.FC<InstrumentCardProps> = ({
  ...
  return (
    <div className="instrument-card bg-black/90 border-4 border-neon-blue rounded-xl shadow-neon-blue/40 relative flex flex-col w-full max-w-[90vw] min-h-[80vh] mx-auto my-8 p-4" style={{ boxShadow: '0 0 32px 4px #00f0ff55' }}>
      {/* Grid Overlay */}
