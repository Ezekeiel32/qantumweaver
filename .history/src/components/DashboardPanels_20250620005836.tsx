...
export const ChartPanel: React.FC<{
  ...
  useEffect(() => {
    const handleResize = () => {
      if (containerRef.current) {
        ...
        setSize({ width: rect.width, height: rect.height - 100 }); // Account for header
      }
    };
    handleResize();
  ...
  return (
    <div className="flex flex-col h-full w-full bg-[#0a0f1c] rounded-lg border border-[#00ffe7]/30 shadow-lg shadow-[#00ffe7]/20">
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b border-[#00ffe7]/20">
        <div className="flex items-center space-x-4">
          <h2 className="text-xl font-bold text-[#00ffe7] font-mono">SPECTRUM ANALYZER</h2>
          <Badge variant="outline" className={`${jobStatus === 'running' ? 'animate-pulse' : ''} bg-[#00ffe7]/10 text-[#00ffe7] border-[#00ffe7]/30`}>
      ...
      {/* Status Bar */}
      <div className="flex items-center justify-between px-4 py-2 bg-[#0a0f1c]/80 border-b border-[#00ffe7]/20">
        <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-2">
          <div className={`w-2 h-2 rounded-full ${jobStatus === 'running' ? 'bg-[#39ff14] animate-pulse' : 'bg-[#ff0000]'}`} />
