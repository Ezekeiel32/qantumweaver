...
const appFeatures = [
  ...
  { href: "/workflow-builder", label: "Workflow Builder", icon: Wand2, description: "Build and manage complex workflows." },
  { href: "/data-portal", label: "Data Portal", icon: Box, description: "Access and manage your data resources." },
];
