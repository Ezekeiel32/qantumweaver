...
function TrainModelPage() {
  ...
  return (
    <div className="relative flex flex-col h-full min-h-screen w-full">
      ...
      <div className="matrix-panel mb-8" style={{ minHeight: '600px', height: '65vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
        ...
        <div className="w-full flex flex-col flex-1">
          ...
          {/* Chart fills width, minimalistic scrollbar if needed */}
          <div className="flex-1 w-full overflow-auto" style={{ minHeight: 320 }}>
