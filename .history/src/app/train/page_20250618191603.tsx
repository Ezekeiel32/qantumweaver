      ...
      <div className="min-h-screen w-full flex flex-row bg-gradient-to-br from-[#181c24] to-[#23283a] bg-noise-pattern">
        ...
        <div className="flex-1 flex flex-col items-center justify-start px-4 py-8">
          <div className="w-full max-w-6xl flex flex-col h-[90vh]">
            ...
            <div className="w-full crt-panel flex flex-col justify-start p-8" style={{ flex: 'none' }}>
            ...
            {/* Training Logs/Terminal directly underneath, visually connected, fills remaining space */}
            <div className="w-full flex-1 flex flex-col overflow-y-auto neon-border" style={{ background: '#10131a', minHeight: '140px' }}>
