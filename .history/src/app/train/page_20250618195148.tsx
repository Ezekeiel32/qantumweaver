...
export default function TrainModelPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full flex flex-row bg-gradient-to-br from-[#181c24] to-[#23283a] bg-noise-pattern">
        ...
        <div className="flex-1 flex flex-col items-center justify-start px-2 py-4">
          <div className="w-full max-w-6xl flex flex-col h-[90vh]" style={{ minHeight: '90vh' }}>
            ...
            <div className="w-full crt-panel neon-border flex flex-col justify-start p-6 md:p-8" style={{ height: '400px', minHeight: '300px', maxHeight: '65%', borderRadius: '18px', boxShadow: '0 0 32px #00ffe7cc, 0 0 8px #00ffe799' }}>
            ...
            <div className="w-full flex-1 flex flex-col overflow-y-auto neon-border" style={{ background: '#0a0f1c', minHeight: '140px', color: '#39ff14', fontFamily: 'Share Tech Mono, VT323, Space Mono, monospace', borderRadius: '18px', boxShadow: '0 0 32px #00ffe7cc, 0 0 8px #00ffe799', marginTop: '-2px' }}>
              {/* Logs header bar */}
      ...
      {/* Modal trigger and modal (floats above dashboard) */}
      <div className="fixed top-8 right-8 z-[2147483647]">
        <Dialog>
          <DialogTrigger asChild>
            <button className="px-6 py-2 rounded-xl neon-border bg-zinc-900/80 text-neon-cyan font-bold text-lg shadow-lg hover:bg-zinc-800/90 transition">Training Configuration</button>
          </DialogTrigger>
