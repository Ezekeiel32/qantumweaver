...
export default function TrainModelClient() {
  ...
  // Show config modal and start button if no job is running
  ...
  return (
    <div className="w-full h-full flex flex-col relative">
      <div className="absolute top-4 right-8 z-30 flex gap-3">
        ...
        {!isJobActive && (
          <Button variant="default" onClick={() => job.startJob(pendingParams)} className="neon-btn">Start Training</Button>
        )}
      </div>
      <InstrumentCard
        jobId={job.jobId}
