        ...
        <Card className="w-full">
          <CardHeader>
            ...
            <CardContent style={{ paddingTop: 8, paddingBottom: 8 }}>
              ...
              <div className="w-full" style={{ minHeight: 260, maxHeight: 340 }}>
                <NeonAnalyzerChart
                  traces={[
              ...
              {/* Log output: fixed max height, scrollable */}
              <div className="w-full bg-black/40 rounded-lg p-3 mt-2 overflow-y-auto" style={{ maxHeight: 260, minHeight: 120 }}>
