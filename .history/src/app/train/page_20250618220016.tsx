...
function TrainModelPage() {
  ...
  return (
    <div className="relative flex flex-col h-full min-h-screen w-full">
      ...
      <div className="matrix-panel mb-6" style={{ minHeight: '480px', height: '48vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
      ...
      {/* Training Logs at the bottom */}
      <div className="w-full mt-auto mb-4">
        <div className="matrix-panel" style={{ minHeight: 120, maxHeight: 220, overflowY: 'auto' }}>
