...
import { Play, StopCircle, List, Zap, Settings, RefreshCw, AlertTriangle, ExternalLink, SlidersHorizontal, Atom, Brain, Waves, BrainCircuit, Wand2, Save, Download, ArrowDownCircle, PlayCircle, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    <div className="container mx-auto p-4 md:p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {!trainConfigMinimized ? (
          ...
          // Floating neon chevron button, bottom left of monitor
          <button
        ...
        {/* Training Monitor Panel (Resizable) */}
        <div
          ref={monitorRef}
          className="relative"
        ...
        >
          <Card className="w-full">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-lg py-1"><List className="h-5 w-5 text-primary" /> <span style={{ fontSize: 18 }}>Training Monitor</span></CardTitle>
            ...
            <CardContent style={{ paddingTop: 8, paddingBottom: 8 }}>
              ...
              <div style={{
                ...
                <span style={{ color: '#00ffe7', fontFamily: 'Share Tech Mono, monospace', fontSize: 16, letterSpacing: 1.2 }}>Status</span>
                <span style={{ background: 'rgba(0,255,255,0.08)', border: '1.5px solid #00ffe7', borderRadius: 16, color: '#00ffe7', fontFamily: 'Share Tech Mono, monospace', fontSize: 15, padding: '2px 18px', boxShadow: '0 0 12px #00ffe7', marginRight: 8 }}>{activeJob?.status?.toUpperCase() || 'NONE'}</span>
                <div style={{ display: 'flex', gap: 10, flex: 1, justifyContent: 'center', minWidth: 0 }}>
                  <div style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 10, padding: '4px 18px', minWidth: 90, textAlign: 'center', border: '1px solid #222' }}>
                    <div style={{ fontSize: 12, color: '#b0b0b0', marginBottom: 0 }}>Epoch</div>
                    <div style={{ fontWeight: 700, fontSize: 18, letterSpacing: 1 }}>{activeJob?.current_epoch ?? '--'}/{activeJob?.total_epochs ?? '--'}</div>
                  </div>
                  <div style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 10, padding: '4px 18px', minWidth: 90, textAlign: 'center', border: '1px solid #222' }}>
                    <div style={{ fontSize: 12, color: '#b0b0b0', marginBottom: 0 }}>Accuracy</div>
                    <div style={{ fontWeight: 700, fontSize: 18, letterSpacing: 1 }}>{activeJob ? `${activeJob.accuracy.toFixed(2)}%` : '--'}</div>
                  </div>
                  <div style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 10, padding: '4px 18px', minWidth: 90, textAlign: 'center', border: '1px solid #222' }}>
                    <div style={{ fontSize: 12, color: '#b0b0b0', marginBottom: 0 }}>Loss</div>
                    <div style={{ fontWeight: 700, fontSize: 18, letterSpacing: 1 }}>{activeJob ? activeJob.loss.toFixed(4) : '--'}</div>
                  </div>
                  <div style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 10, padding: '4px 18px', minWidth: 90, textAlign: 'center', border: '1px solid #222' }}>
                    <div style={{ fontSize: 12, color: '#b0b0b0', marginBottom: 0 }}>Avg ZPE</div>
                    <div style={{ fontWeight: 700, fontSize: 18, letterSpacing: 1 }}>{activeJob?.zpe_effects && activeJob.zpe_effects.length > 0 ? (activeJob.zpe_effects.reduce((a, b) => a + b, 0) / activeJob.zpe_effects.length).toFixed(2) : '--'}</div>
                  </div>
                </div>
