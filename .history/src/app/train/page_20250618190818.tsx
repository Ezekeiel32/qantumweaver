        ...
        <div className="flex-1 flex flex-col items-center justify-start px-4 py-8">
          <div className="w-full max-w-6xl flex flex-col h-[90vh] gap-4">
            ...
            <div className="flex-1 min-h-0" style={{ flexBasis: '65%', maxHeight: '65%' }}>
              <div className="w-full h-full crt-panel flex flex-col justify-start p-8">
            ...
            <div className="flex-none w-full crt-panel p-4 flex flex-col overflow-y-auto" style={{ flexBasis: '35%', maxHeight: '35%', minHeight: '140px' }}>
              <div className="crt-scanlines" />
              <div className="crt-grid" />
