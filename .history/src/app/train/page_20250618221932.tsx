...
function TrainModelPage() {
  ...
  return (
    <div className="relative flex flex-col h-full min-h-screen w-full">
      ...
      <div className="matrix-panel mb-4" style={{ minHeight: '680px', height: '72vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
        ...
        <div className="w-full flex flex-col flex-1">
          ...
          {/* Chart fills entire neon-bordered area, only horizontal scroll if needed */}
          <div className="flex-1 w-full" style={{ minHeight: 340, display: 'flex', alignItems: 'stretch', justifyContent: 'stretch' }}>
            <div
