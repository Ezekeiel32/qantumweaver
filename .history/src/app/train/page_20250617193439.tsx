...
export default function TrainModelPage() {
  ...
  useLayoutEffect(() => {
    ...
    // Use double requestAnimationFrame for post-paint scroll
    requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        const el = retroLogRef.current;
            ...
            {isMonitorLoading ? (
              ...
              <div className="space-y-6">
                ...
                <ScrollArea className="h-[200px] w-full rounded-md border bg-[#18181b] retro-terminal overflow-auto relative" style={{ fontFamily: '"Fira Mono", "JetBrains Mono", "IBM Plex Mono", monospace', boxShadow: '0 0 24px #00ffcc44', border: '2px solid #00ffcc', background: 'repeating-linear-gradient(0deg, #18181b 0px, #18181b 2px, #1a1a1e 4px, #18181b 6px)', color: '#00ffcc' }}>
                  <div className="p-4" ref={retroLogRef} id="retro-log-container" key={activeJob?.log_messages?.length || 0} style={{ height: '100%', overflowY: 'auto', position: 'relative' }}>
