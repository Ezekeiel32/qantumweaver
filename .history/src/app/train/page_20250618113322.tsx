        ...
        <Card className="w-full">
          <CardHeader>
            ...
            <CardContent style={{ paddingTop: 8, paddingBottom: 8 }}>
              ...
              {/* Chart always visible below widgets */}
              <div className="w-full flex-1" style={{ minHeight: 260, maxHeight: 340 }}>
                <NeonAnalyzerChart
                  traces={[
              ...
              {/* Terminal output: docked at bottom, 6 lines tall, scrollable */}
              <div className="w-full bg-black/40 rounded-lg p-3 overflow-y-auto" style={{ height: 100, minHeight: 80, maxHeight: 120, marginTop: 0, marginBottom: 0, position: 'relative' }}>
