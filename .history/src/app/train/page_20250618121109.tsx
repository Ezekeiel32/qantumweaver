  ...
  return (
    <>
      ...
      <div style={{
          ...
          <Card className="w-full">
            <CardHeader>
              ...
              <CardContent style={{ display: 'flex', flexDirection: 'column', height: '100%', paddingTop: 8, paddingBottom: 8 }}>
                ...
                <div className="flex flex-col flex-1 w-full" style={{minHeight: 0, height: '100%'}}>
                  <div className="w-full flex-1" style={{ flexGrow: 1, flexShrink: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', minHeight: 0, height: '100%' }}>
                    <NeonAnalyzerChart
                      traces={[
                    ...
                    <div className="glass neon-border mt-3" style={{ width: chartDims.width, minWidth: 320, maxWidth: '100%', height: 320, minHeight: 300, maxHeight: 340, overflowY: 'auto', borderRadius: 12, boxShadow: '0 0 16px #00ffe7', border: '2px solid #00ffe7', background: 'rgba(20, 20, 40, 0.85)', marginLeft: 0, marginRight: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0.5em 0.7em', fontFamily: 'var(--font-mono)', fontSize: '1em', lineHeight: '1.2' }}>
        ...
        >
          <Card className="w-full h-full relative" style={{ minWidth: minPanelWidth, maxWidth: 600, height: '100%', borderRadius: 18, boxShadow: '0 0 32px #00ffe7AA', border: '3px solid #00ffe7', background: '#181a22F2', overflow: 'auto', margin: 0, padding: 0 }}>
          <CardHeader>
