...
export default function TrainModelPage() {
  ...
  useEffect(() => {
    function handleResize() {
      setChartDims({
        width: typeof window !== 'undefined' ? window.innerWidth - 128 : 1200,
        height: typeof window !== 'undefined' ? Math.max(340, window.innerHeight * 0.45) : 500,
      });
    }
    handleResize();
            ...
            <Card className="w-full">
              ...
              <CardContent style={{ paddingTop: 8, paddingBottom: 8 }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0, minWidth: 0, padding: '0 32px 24px 32px' }}>
                  <div style={{ flex: 2, minHeight: 0, minWidth: 0, marginTop: 8, marginBottom: 8, width: '100%' }}>
                    <NeonAnalyzerChart
                      traces={[
