  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 1200, flex: '0 0 auto', margin: 0, padding: 0 }}>
        ...
        <div className="glass neon-border mt-2" style={{ width: '100%', maxWidth: 1200, height: 220, minHeight: 180, maxHeight: 240, overflowY: 'auto', borderRadius: 12, boxShadow: '0 0 8px #00ffe7', border: '1.5px solid #00ffe7', background: 'rgba(20, 20, 40, 0.85)', margin: 0, padding: '0.5em 0.7em', fontFamily: 'var(--font-mono)', fontSize: '1em', lineHeight: '1.2' }}>
        ...
        <div style={{ width: '100%', maxWidth: 1200, flex: '1 1 0%', margin: 0, padding: 0, overflowY: 'auto' }}>
