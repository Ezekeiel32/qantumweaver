...
export default function TrainModelClient() {
  ...
  const [configBtnContainer, setConfigBtnContainer] = useState<Element | null>(null);

  useEffect(() => {
    setConfigBtnContainer(document.getElementById("config-btn-slot"));
  }, []);
  ...
  return (
    <div className="w-full h-full flex flex-col relative">
      ...
      />
      {configBtnContainer && createPortal(
        <Button variant="outline" onClick={() => setShowConfig(true)} className="neon-btn">Configure</Button>,
        configBtnContainer
      )}
