      ...
      <div style={{
        ...
        {!configMinimized && (
          <div
            style={{
              width: 10,
              cursor: 'ew-resize',
              background: draggingDivider ? '#00ffe7AA' : 'transparent',
              zIndex: 30,
              position: 'relative',
              transition: 'background 0.2s',
              userSelect: 'none',
            ...
            onMouseDown={e => {
              ...
              dragStartConfigWidth.current = configWidth;
              dragStartMonitorWidth.current = monitorWidth;
            }}
            title="Resize panels"
          />
        )}
        ...
        <div
          style={{
            ...
            maxWidth: '100%',
            width: configMinimized ? '100%' : monitorWidth,
            transition: 'width 0.25s cubic-bezier(.4,2,.6,1)',
            position: 'relative',
            zIndex: 10,
            display: 'flex',
        ...
        >
          ...
          {/* Floating restore button for config when minimized */}
          {configMinimized && (
            <button
              onClick={() => setConfigMinimized(false)}
              style={{
                position: "fixed",
                left: 32,
                bottom: 32,
            ...
            >
              <ChevronRight className="h-8 w-8" style={{ color: "#00ffe7", filter: "drop-shadow(0 0 8px #00ffe7)" }} />
            </button>
          )}
        </div>
      </div>
