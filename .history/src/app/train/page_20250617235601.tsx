        ...
        {!monitorMaximized && (
          ...
          >
            <Card className="w-full">
              ...
              <CardContent style={{ paddingTop: 8, paddingBottom: 8 }}>
                ...
                <div style={{
                  ...
                  {activeJob?.status === 'running' && (
                    ...
                    title="Stop Job"
                  >
                    <StopCircle className="mr-1 h-4 w-4" /> Stop Job
                  </button>
                )}
              </div>
              {/* Chart, fills available width */}
              <div style={{ width: monitorWidth - 32, minWidth: 320, height: 320, margin: '0 auto', marginTop: 0, marginBottom: 8, transition: 'width 0.2s' }}>
                <NeonAnalyzerChart
                  traces={[
              ...
              {/* Training logs below chart */}
              <ScrollArea className="h-[200px] w-full rounded-md border bg-[#18181b] retro-terminal overflow-auto relative" style={{ fontFamily: '"Fira Mono", "JetBrains Mono", "IBM Plex Mono", monospace', boxShadow: '0 0 24px #00ffcc44', border: '2px solid #00ffcc', background: 'repeating-linear-gradient(0deg, #18181b 0px, #18181b 2px, #1a1a1e 4px, #18181b 6px)', color: '#00ffcc', marginTop: 8 }}>
