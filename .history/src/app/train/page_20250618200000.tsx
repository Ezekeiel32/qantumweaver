      ...
      <div className="min-h-screen w-full flex flex-row bg-gradient-to-br from-[#181c24] to-[#23283a] bg-noise-pattern">
        ...
        <div className="flex-1 flex flex-col items-center justify-start px-2 py-4">
          <div className="w-full max-w-6xl flex flex-col h-[90vh]" style={{ minHeight: '90vh' }}>
            ...
            <div className="w-full crt-panel neon-border flex flex-col justify-start p-6 md:p-8" style={{ height: '650px', minHeight: '340px', maxHeight: '75vh', borderRadius: '18px', boxShadow: '0 0 32px #00ffe7cc, 0 0 8px #00ffe799' }}>
            ...
            <div className="w-[96%] mx-auto flex flex-col overflow-y-auto neon-border" style={{ background: '#0a0f1c', minHeight: 'calc(1.5em * 17)', maxHeight: 'calc(1.5em * 17)', color: '#39ff14', fontFamily: 'Share Tech Mono, VT323, Space Mono, monospace', borderRadius: '18px', boxShadow: '0 0 32px #00ffe7cc, 0 0 8px #00ffe799' }}>
              {/* Logs header bar */}
