  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', flex: '0 0 340px', minHeight: 260, maxHeight: 400, margin: 0, padding: 0, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
          <Card className="w-full">
            <CardHeader>
                ...
                <CardContent style={{ display: 'flex', flexDirection: 'column', height: '100%', paddingTop: 8, paddingBottom: 8 }}>
                  ...
                  <div className="flex flex-col flex-1 w-full min-h-0" style={{height: '100%', minHeight: 0}}>
                    <div className="w-full flex-1 min-h-0" style={{ flexGrow: 1, flexShrink: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', minHeight: 0, height: '100%' }}>
                      <NeonAnalyzerChart
                        traces={[
        ...
        <div className="glass neon-border" style={{ width: '100%', flex: '0 0 260px', minHeight: 180, maxHeight: 320, overflowY: 'auto', borderRadius: 12, boxShadow: '0 0 8px #00ffe7', border: '1.5px solid #00ffe7', background: 'rgba(20, 20, 40, 0.85)', margin: 0, padding: '0.5em 0.7em', fontFamily: 'var(--font-mono)', fontSize: '1em', lineHeight: '1.2' }}>
          <div className="p-0" ref={retroLogRef} id="retro-log-container" style={{ height: '100%', overflowY: 'auto', position: 'relative' }}>
            <h4 className="mb-1 text-xs font-medium leading-none text-[#00ffcc] drop-shadow-[0_0_4px_#00ffcc]" style={{ fontFamily: 'var(--font-mono)' }}>Training Logs</h4>
            <div style={{ fontSize: '1em', lineHeight: '1.2', letterSpacing: '0.01em', fontFamily: 'var(--font-mono)' }}>
        ...
        <div style={{ width: '100%', flex: '1 1 0%', minHeight: 0, margin: 0, padding: 0, overflowY: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
          <Card className="w-full h-full relative" style={{ height: '100%', borderRadius: 18, boxShadow: '0 0 16px #00ffe7AA', border: '1.5px solid #00ffe7', background: 'rgba(24,26,34,0.98)', overflow: 'auto', margin: 0, padding: 0 }}>
            <CardHeader>
              ...
              <form onSubmit={handleStartNewTraining} className="space-y-6" key={formKey}>
                ...
                <div className="flex gap-4 mt-4 w-full" style={{ fontFamily: 'var(--font-mono)' }}>
                  <Button
                    type="button"
