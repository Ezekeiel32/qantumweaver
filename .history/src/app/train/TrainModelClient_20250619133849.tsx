  ...
  return (
    <div className="w-full h-full flex flex-col relative">
      ...
      <Dialog open={showConfig} onOpenChange={setShowConfig}>
        <DialogContent className="max-w-3xl w-full neon-card" style={{ fontFamily: 'Share Tech Mono, Space Mono, VT323, monospace', background: '#18181b', border: '2px solid #00ffe7', boxShadow: '0 0 32px 4px #00f0ff55', color: '#00ffe7' }}>
          <DialogHeader>
