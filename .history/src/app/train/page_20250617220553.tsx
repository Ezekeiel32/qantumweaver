            ...
            {isMonitorLoading ? (
              ...
              <div className="space-y-6">
                ...
                <div className="h-[300px]">
                  <NeonAnalyzerChart
                    traces={[
                      { data: chartData.map(d => d.accuracy), color: '#00ffe7', label: 'Accuracy' },
                      { data: chartData.map(d => d.loss), color: '#ff00ff', label: 'Loss' },
                      { data: chartData.map(d => d.avg_zpe), color: '#ffe066', label: 'Avg ZPE' },
                    ]}
                    width={600}
                    height={300}
                    overlays={[
