...
export default function TrainModelPage() {
  ...
  return (
    <>
      {/* Training Monitor and Dashboard (always visible) */}
      <div className="min-h-screen w-full flex flex-col items-center justify-start bg-gradient-to-br from-[#181c24] to-[#23283a] bg-noise-pattern">
        <div className="w-full max-w-6xl flex flex-col gap-6 px-4 py-8">
          ...
          <div className="w-full glass neon-border rounded-2xl shadow-xl flex flex-col justify-start p-8 backdrop-blur-md bg-zinc-900/80 border border-neon-cyan/60 mb-6">
            ...
            <CardContent className="flex flex-col flex-1 min-h-0 p-0">
              ...
              <div className="flex flex-col flex-1 w-full min-h-0">
                <div className="w-full flex-1 min-h-0 flex flex-col items-start min-h-0 h-[48vh]">
          ...
          {/* Training Logs directly below the chart, fixed height, scrollable */}
          <div className="w-full glass neon-border rounded-2xl shadow-xl p-4 flex flex-col bg-zinc-900/80 backdrop-blur-md overflow-y-auto" style={{ maxHeight: '28vh', minHeight: '180px' }}>
