...
function TrainModelPage() {
  ...
  return (
    <>
      ...
      <div className="h-full w-full grid grid-rows-[45%_20%_35%] gap-4 p-4 bg-transparent">
        {/* Top: Training Monitor (chart + metrics bar) */}
        <div className="w-full h-full glass neon-border rounded-2xl shadow-2xl flex flex-col justify-start p-6 backdrop-blur-md bg-zinc-900/70">
        ...
        <div className="w-full h-full glass neon-border rounded-2xl shadow-2xl flex flex-col bg-zinc-900/70 backdrop-blur-md p-6 overflow-y-auto">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center gap-3 text-2xl font-headline text-primary drop-shadow-neon">
