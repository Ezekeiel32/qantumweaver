...
export default function TrainModelClient() {
  ...
  return (
    <div className="w-full h-full flex flex-col relative items-center bg-black/95 min-h-screen">
      {/* Neon grid overlay */}
      ...
      <div className="w-full max-w-6xl flex flex-col gap-6 z-10 mt-8">
        <InstrumentCard
          jobId={job.jobId}
          ...
          onStartAdvisorTraining={handleStartAdvisorTraining}
        />
      </div>
      <Dialog open={showConfig} onOpenChange={setShowConfig}>
        <DialogContent className="neon-card" style={{
          fontFamily: 'Share Tech Mono, Space Mono, VT323, monospace',
          background: 'radial-gradient(ellipse at center, #18181b 80%, #00ffe733 100%)',
