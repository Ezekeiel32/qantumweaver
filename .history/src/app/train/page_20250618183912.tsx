      ...
      <div className="min-h-screen w-full flex flex-row bg-gradient-to-br from-[#181c24] to-[#23283a] bg-noise-pattern">
        ...
        <div className="flex-1 flex flex-col items-center justify-start px-4 py-8">
          <div className="w-full max-w-6xl flex flex-col h-[90vh] gap-4">
            ...
            <div className="flex-none w-full glass neon-border rounded-2xl shadow-xl p-4 flex flex-col bg-zinc-900/80 backdrop-blur-md overflow-y-auto" style={{ flexBasis: '35%', maxHeight: '35%', minHeight: '140px' }}>
