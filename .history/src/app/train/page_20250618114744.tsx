          ...
          <CardHeader>
            ...
            <CardContent style={{ display: 'flex', flexDirection: 'column', height: '100%', paddingTop: 8, paddingBottom: 8 }}>
              ...
              <div className="w-full flex-1" style={{ minHeight: 220, maxHeight: 340, flexGrow: 1, flexShrink: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                ...
                <div className="glass neon-border mt-3" style={{ width: chartDims.width, minWidth: 320, maxWidth: '100%', height: 100, minHeight: 80, maxHeight: 120, overflowY: 'auto', borderRadius: 12, boxShadow: '0 0 16px #00ffe7', border: '2px solid #00ffe7', background: 'rgba(20, 20, 40, 0.85)', marginLeft: 0, marginRight: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
                  <div className="p-2" ref={retroLogRef} id="retro-log-container" style={{ height: '100%', overflowY: 'auto', position: 'relative' }}>
                    <h4 className="mb-2 text-xs font-medium leading-none text-[#00ffcc] drop-shadow-[0_0_4px_#00ffcc]">Training Logs</h4>
                    <div style={{ fontSize: '1em', lineHeight: '1.35', letterSpacing: '0.01em' }}>
