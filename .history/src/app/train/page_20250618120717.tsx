  ...
  return (
    <>
      ...
      <div style={{
        ...
        >
          <Card className="w-full h-full relative" style={{ minWidth: minPanelWidth, maxWidth: 600, height: '100%', borderRadius: 18, boxShadow: '0 0 32px #00ffe7AA', border: '3px solid #00ffe7', background: '#181a22F2', overflow: 'auto' }}>
          <CardHeader>
