        ...
        <Card className="w-full">
          <CardHeader>
            ...
            <CardContent style={{ display: 'flex', flexDirection: 'column', height: '100%', paddingTop: 8, paddingBottom: 8 }}>
              ...
              <div className="w-full flex-1" style={{ minHeight: 220, maxHeight: 340, flexGrow: 1, flexShrink: 1 }}>
                <NeonAnalyzerChart
                  traces={[
              ...
              {/* Terminal output: always at bottom, 6 lines tall, scrollable */}
              <div className="w-full bg-black/40 rounded-lg p-3 overflow-y-auto" style={{ height: 100, minHeight: 80, maxHeight: 120, marginTop: 0, marginBottom: 0, position: 'relative', flexShrink: 0 }}>
