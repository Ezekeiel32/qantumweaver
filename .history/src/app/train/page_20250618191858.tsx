      ...
      <div className="min-h-screen w-full flex flex-row bg-gradient-to-br from-[#181c24] to-[#23283a] bg-noise-pattern">
        ...
        <div className="flex-1 flex flex-col items-center justify-start px-4 py-8">
          <div className="w-full max-w-6xl flex flex-col h-[90vh]" style={{ minHeight: '90vh' }}>
            ...
            <div className="w-full crt-panel flex flex-col justify-start p-8" style={{ height: '60vh', minHeight: '340px', maxHeight: '65%' }}>
              <div className="crt-scanlines" />
              <div className="crt-grid" />
              {/* Chart and metrics content here */}
              ...
              <CardContent className="flex flex-col flex-1 min-h-0 p-0">
                ...
                <div className="flex-1 w-full min-h-0 flex flex-col items-start">
                  <div className="w-full flex-1 min-h-0 h-full">
                    {/* Instrument-style status margin at the top of the monitor */}
                    <div className="w-full flex items-center justify-between px-6 py-2 bg-black/40 border-b border-neon-cyan/40 rounded-t-xl mb-2" style={{ minHeight: '38px' }}>
                      {activeJob ? (
                        <span className="font-mono text-base text-neon-cyan">{activeJob.parameters.modelName} <span className="ml-4 text-xs text-muted-foreground">[{activeJob.status?.toUpperCase()}]</span></span>
                      ) : (
                        <span className="font-mono text-base text-neon-cyan/60">No training data yet. Start a job to see progress.</span>
                      )}
                    </div>
                    {/* Chart area below */}
                    {chartData.length === 0 && (
            ...
            <div className="w-full flex-1 flex flex-col overflow-y-auto neon-border" style={{ background: '#10131a', minHeight: '140px', color: '#39ff14', fontFamily: 'Share Tech Mono, VT323, Space Mono, monospace' }}>
