...
export default function TrainModelPage() {
  ...
  // --- Main layout ---
  return (
    <div className="container mx-auto p-4 md:p-6" style={{ filter: monitorMaximized ? 'blur(2px) brightness(0.7)' : undefined, pointerEvents: monitorMaximized ? 'none' : undefined }}>
