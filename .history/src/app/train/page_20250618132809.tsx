  ...
  return (
    <>
      ...
      <div style={{
              ...
              <CardContent style={{ display: 'flex', flexDirection: 'column', height: '100%', paddingTop: 8, paddingBottom: 8 }}>
                ...
                <div className="flex flex-col flex-1 w-full min-h-0" style={{height: '100%', minHeight: 0}}>
                  <div className="w-full flex-1 min-h-0" style={{ flexGrow: 1, flexShrink: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', minHeight: 0, height: '100%' }}>
                    ...
                    <div className="glass neon-border mt-2" style={{ width: '100%', height: 220, minHeight: 180, maxHeight: 240, overflowY: 'auto', borderRadius: 12, boxShadow: '0 0 8px #00ffe7', border: '1.5px solid #00ffe7', background: 'rgba(20, 20, 40, 0.85)', margin: 0, padding: '0.5em 0.7em', fontFamily: 'var(--font-mono)', fontSize: '1em', lineHeight: '1.2' }}>
        ...
        >
          <Card className="w-full h-full relative" style={{ minWidth: minPanelWidth, maxWidth: 600, height: '100%', borderRadius: 18, boxShadow: '0 0 16px #00ffe7AA', border: '1.5px solid #00ffe7', background: 'rgba(24,26,34,0.98)', overflow: 'auto', margin: 0, padding: 0 }}>
          <CardHeader>
