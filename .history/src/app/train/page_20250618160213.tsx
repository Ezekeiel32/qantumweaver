                          ...
                          <div className="bg-zinc-900/90 border border-neon-cyan/40 rounded-xl p-4 flex flex-col gap-2 shadow-md">
                            <div className="flex items-center gap-2 mb-1">
                              <Label className="text-base font-bold text-neon-cyan flex items-center gap-1">
                                Mixup Alpha
                                <TooltipProvider><TooltipTrigger><span className="ml-1 text-xs text-neon-cyan/70 cursor-help">?</span></TooltipTrigger><TooltipContent>Controls the strength of synthetic/quantum noise (Mixup). Higher values = more noise, more generalization.</TooltipContent></TooltipProvider>
                              </Label>
