...
def train_model(initial_params: Optional[TrainingParameters] = None, previous_job_id: Optional[str] = None):
...
if __name__ == "__main__":
    ...
    # )
    # model, accuracy = train_model(custom_params, previous_job_id="job_123") 